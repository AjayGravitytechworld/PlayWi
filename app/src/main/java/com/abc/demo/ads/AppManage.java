...
public class AppManage {
    ...
    public static String nativebg1;
    public static int backbutton;
    public static int soon;
    public static String adtextcolor1;
    public static String btncr1;
    public static String btntextcr1;
    public static String openappswwitch;
    public static int nativeadtype = 0;
    public static String nativebg;
    public static String adtextcolor;
    public static String btncr;
    public static String btntextcr;
    public static int cfulladcount;
    public static int quiz;
    public static int cbackfulladcount;
    ...
    public static void getResponseFromPref() {
        ...
        SharedPreferences.Editor editor_init = mysharedpreferences.edit();
        ...
        if (!response1.isEmpty()) {
            try {
                ...
                btntextcr = settingsJsonObject.getString("btntextcr");
                btncr = settingsJsonObject.getString("btncr");
                adtextcolor1 = settingsJsonObject.getString("adtextcolor1");
                nativebg1 = settingsJsonObject.getString("nativebg1");
                btncr1 = settingsJsonObject.getString("btncr1");
                btntextcr1 = settingsJsonObject.getString("btntextcr1");
                adtextcolor = settingsJsonObject.getString("adtextcolor");
                nativebg = settingsJsonObject.getString("nativebg");

                cbackfulladcount = settingsJsonObject.getInt("cbackfulladcount");
                cfulladcount = settingsJsonObject.getInt("cfulladcount");
                backbutton = settingsJsonObject.getInt("backbutton");
                soon = settingsJsonObject.getInt("soon");
                quiz = settingsJsonObject.getInt("quiz");
                link1 = settingsJsonObject.getString("link1");
                link2 = settingsJsonObject.getString("link2");
                Qureka = settingsJsonObject.getString("qurekalink");
                onesignal = settingsJsonObject.getString("onesignal");
                customappopen = settingsJsonObject.getString("customappopen");
                ...
                editor.putString("qurekalink", Qureka);
                editor.putString("onesignal", onesignal);
                editor.putString("link1", link1);
                editor.putString("link2", link2);
                editor.putString("customappopen", customappopen);
                editor.putInt("cfulladcount", cfulladcount);
                editor.putInt("backbutton", backbutton);
                editor.putInt("soon", soon);
                editor.putInt("quiz", quiz);
                editor.putInt("cbackfulladcount", cbackfulladcount);
                editor.putString("nativebg1", nativebg1);
                editor.putString("adtextcolor1", adtextcolor1);
                editor.putString("btncr", btncr);
                editor.putString("btntextcr", btntextcr);
                editor.putString("btntextcr1", btntextcr1);
                editor.putString("nativebg", nativebg);
                editor.putString("adtextcolor", adtextcolor);
                ...
                editor.putInt("app_ad_analysis", settingsJsonObject.getInt("app_ad_analysis"));
                ...
                editor.putString("AppOpenID", AdmobJsonObject.getString("AppOpen1")).apply();
    ...
    private void initAd() {
        ...
        new AdsAnalysis(activity).init_adAnalysis();
    ...
    public void getResponseFromPref(getDataListner listner, int cversion) {
        ...
        if (!response1.isEmpty()) {
            try {
                ...
                editor.putString("adtextcolor", adtextcolor);
                editor.putString("nativebg", nativebg);
                editor.putString("openappswwitch", openappswwitch);
                editor.putString("btncr1", btncr1);
                ...
                JSONObject FBJsonObject = response.getJSONObject("PLACEMENT").getJSONObject(FACEBOOK);
                facebook_AdStatus = FBJsonObject.getInt("ad_showAdStatus");
                facebook_loadAdIdsType = FBJsonObject.getInt("ad_loadAdIdsType");
                FACEBOOK_B[0] = FBJsonObject.getString("Banner1");
                FACEBOOK_NB[0] = FBJsonObject.getString("NativeBanner1");
    ...
    private void loadFacebookInterstitial(final Activity activity, String facebook_i) {
        ...
        fbinterstitialAd1.loadAd(fbinterstitialAd1.buildLoadAdConfig().withAdListener(new AbstractAdListener() {
            ...
            public void onError(Ad ad, AdError error) {
                ...
                new AdsAnalysis(activity).count_adAnalysis(FACEBOOK, "REQ_FAIL", error.getErrorMessage() + "");
                if (facebook_loadAdIdsType == 2) {
            ...
            public void onAdLoaded(Ad ad) {
                super.onAdLoaded(ad);
                new AdsAnalysis(activity).count_adAnalysis(FACEBOOK, "REQ_LOAD");
            }

            @Override
            public void onInterstitialDisplayed(Ad ad) {
                super.onInterstitialDisplayed(ad);
                new AdsAnalysis(activity).count_adAnalysis(FACEBOOK, "AD_SHOW");
            }
...
//                fbinterstitialAd1.loadAd();
            ...
            public void onLoggingImpression(Ad ad) {
                ...
                new AdsAnalysis(activity).count_adAnalysis(FACEBOOK, "AD_IMP");
            }
        }).build());
    }
    ...
    private void loadAdmobInterstitial(final Activity activity, String google_i) {
        ...
        Log.e("TAGaaaaa", "loadAdmobInterstitial");
        ...
        InterstitialAd.load(activity, google_i, adRequest, new InterstitialAdLoadCallback() {
            ...
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                ...
                Log.e("TAGaaaaa", "onAdLoaded");
                new AdsAnalysis(activity).count_adAnalysis(ADMOB, "REQ_LOAD");

                mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                    @Override
                    public void onAdDismissedFullScreenContent() {
                        // Called when fullscreen content is dismissed.
                        Log.e("TAGaaaaa", "The ad was dismissed.");
                        if (admob_loadAdIdsType == 2) {
                    ...
                    public void onAdImpression() {
                        ...
                        new AdsAnalysis(activity).count_adAnalysis(ADMOB, "AD_IMP");
                    }

                    @Override
                    public void onAdFailedToShowFullScreenContent(com.google.android.gms.ads.AdError adError) {
                        // Called when fullscreen content failed to show.
                        Log.e("TAGaaaaa", "The ad failed to show.");
                        new AdsAnalysis(activity).count_adAnalysis(ADMOB, "ERROR_FAIL");
                    }
                    ...
                    public void onAdShowedFullScreenContent() {
                        ...
                        Log.e("TAGaaaaa", "The ad was shown.");
                        new AdsAnalysis(activity).count_adAnalysis(ADMOB, "AD_SHOW");
                    }
                });
            }
            ...
            public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                // Handle the error
                mInterstitialAd = null;
                new AdsAnalysis(activity).count_adAnalysis(ADMOB, "REQ_FAIL", loadAdError.getMessage() + "");
    ...
    private void displayInterstitialAd(String platform, final Context context) {
        Log.e("TAGaaaaa", "displayInterstitialAd");
...
//                fbinterstitialAd1.loadAd();
    ...
    private void nextInterstitialPlatform(Context context) {
        Log.e("TAGaaaaa", "nextInterstitialPlatform");
        ...
        if (interstitial_sequence.size() != 0) {
            ...
            if (interstitial_sequence.size() != 0) {
                displayInterstitialAd(interstitial_sequence.get(0), context);
                Log.e("TAGaaaaa", "displayInterstitialAd1");
            } else {
                interstitialCallBack();
                Log.e("TAGaaaaa", "interstitialCallBack");
            }
...
//            }
        ...
        if (fbBannerAd_preLoad == null) {
            ...
            com.facebook.ads.AdListener adListener = new com.facebook.ads.AdListener() {
                ...
                public void onError(Ad ad, AdError adError) {
                    ...
                    banner_container.removeAllViews();
                    nextBannerPlatform(banner_container);
                    new AdsAnalysis(activity).count_adAnalysis(FACEBOOK, "REQ_FAIL");
                }
        ...
        if (admobBannerAd_preLoad == null) {
            ...
            mAdView.setAdListener(new AdListener() {
                ...
                public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                    ...
                    banner_container.removeAllViews();
                    nextBannerPlatform(banner_container);
                    new AdsAnalysis(activity).count_adAnalysis(ADMOB, "REQ_FAIL");
                }
    ...
    private void preLoadBanner(String platform) {
        ...
        if (platform.equals(ADMOB)) {
            ...
            if (fbBannerAd_preLoad == null && state_fbBanner.equals("Loaded")) {
                state_fbBanner = "Start";
            }
    ...
    private void showMyCustomNativeBanner(final ViewGroup nbanner_container) {
        ...
        if (appModal != null) {
            ...
            TextView btn_call_to_action = inflate2.findViewById(R.id.cta);
...
//            }
            ...
            Glide.with(activity).load(appModal.getApp_logo()).diskCacheStrategy(DiskCacheStrategy.ALL).listener(new RequestListener<Drawable>() {
                ...
                public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                    ...
                    showMyCustomNativeBanner(nbanner_container);
                    return false;
                }
...
//        }
        ...
        if (fbNativeBannerAd_preLoad == null && state_fbNativeBanner.equals("Loaded")) {
            state_fbNativeBanner = "Start";
        }
    ...
    private void showNativeAdmobBanner(final ViewGroup banner_container) {
        ...
        if (admobBannerAd_preLoad == null) {
            ...
            if (admobBannerAd_preLoad.getParent() != null) {
                ((ViewGroup) admobBannerAd_preLoad.getParent()).removeView(admobBannerAd_preLoad); // <- fix
            }
            banner_container.addView(admobBannerAd_preLoad);
...
//            banner_container.addView(admobBannerAd_preLoad);
    ...
    public void showNative(ViewGroup nativeAdContainer, String admobN, String facebookN, String user) {
        mainUser = user;
        nativeadtype = 0;
        turnShowNative(nativeAdContainer, admobN, facebookN);
    }

    public void showNativetype(ViewGroup nativeAdContainer, String admobN, String facebookN, String user, int type) {
        mainUser = user;
        nativeadtype = type;
        turnShowNative(nativeAdContainer, admobN, facebookN);
    }

    public void showNativeSmall(ViewGroup nativeAdContainer, String admobN, String facebookN, String user) {
        turnShowNativeSmall(nativeAdContainer, admobN, facebookN);
        mainUser = user;
    }
    ...
    public void turnShowNativeSmall(ViewGroup nativeAdContainer, String admobN, String facebookN) {
        this.admob_n = admobN;
        this.facebook_n = facebookN;
        ...
        if (native_sequence.size() != 0) {
            ...
            displayNativeSmall(native_sequence.get(0), nativeAdContainer);
        }
    ...
    private void displayNativeSmall(String platform, ViewGroup nativeAdContainer) {
        ...
        if (platform.equals(ADMOB) && admob_AdStatus == 1) {
            ...
            showAdmobNativeSmall(nativeAdContainer);
        } else if (platform.equals(FACEBOOK) && facebook_AdStatus == 1) {
            if ((facebook_loadAdIdsType == 0 || facebook_loadAdIdsType == 2 || facebook_n.equals("random")) && !facebook_n.isEmpty()) {
                facebook_n = getRandomPlacementId(FACEBOOK, "N");
            }

            showFacebookNativeSmall(nativeAdContainer);
        } else if (platform.equals(MyCustomAds) && myCustom_AdStatus == 1) {
            showMyCustomNative(nativeAdContainer);
        } else {
            nextNativePlatform(nativeAdContainer);
    ...
    private void showMyCustomNative(final ViewGroup nativeAdContainer) {
        ...
        if (appModal != null) {
            ...
            if (nativeadtype == 1) {
                inflate = LayoutInflater.from(activity).inflate(R.layout.cust_native, nativeAdContainer, false);
            } else if (nativeadtype == 2) {
                inflate = LayoutInflater.from(activity).inflate(R.layout.cust_native2, nativeAdContainer, false);
            } else if (nativeadtype == 3) {
                inflate = LayoutInflater.from(activity).inflate(R.layout.cust_native_intro, nativeAdContainer, false);
            } else if (nativeadtype == 4) {
                inflate = LayoutInflater.from(activity).inflate(R.layout.cust_native_intro1, nativeAdContainer, false);
            } else {
                inflate = LayoutInflater.from(activity).inflate(R.layout.cust_native, nativeAdContainer, false);
            }
            ...
            TextView btn_call_to_action = inflate.findViewById(R.id.cta);
...
//            }
    ...
    private void showFacebookNativeSmall(final ViewGroup nativeAdContainer) {
        if (facebook_n.isEmpty() || facebook_AdStatus == 0) {
            nextNativePlatform(nativeAdContainer);
            return;
        }
        ...
        if (fbNativeAd_preLoad == null) {
            ...
            nativeAd.loadAd(nativeAd.buildLoadAdConfig().withAdListener(new NativeAdListener() {
                ...
                public void onAdLoaded(Ad ad) {
                    ...
                    inflate_NATIV_FBSmall(nativeAd, nativeAdContainer);
                    new AdsAnalysis(activity).count_adAnalysis(FACEBOOK, "REQ_LOAD");
                    new AdsAnalysis(activity).count_adAnalysis(FACEBOOK, "AD_SHOW");
                }
            ...
            state_fbNative = "Start";
            inflate_NATIV_FBSmall(fbNativeAd_preLoad, nativeAdContainer);
        }
    ...
    public void inflate_NATIV_FB(com.facebook.ads.NativeAd nativeAd, ViewGroup card) {
        ...
        if (nativeadtype == 1) {
            adView = (View) inflater.inflate(R.layout.ads_nativ_fb, null);
        } else if (nativeadtype == 2) {
            adView = (View) inflater.inflate(R.layout.ads_nativ_fb_undhi, null);
//            adView = (View) inflater.inflate(R.layout.ads_nativ_admob_home, null);
        } else if (nativeadtype == 3) {
            adView = (View) inflater.inflate(R.layout.ads_nativ_fb_smallsmall, null);
        } else if (nativeadtype == 4) {
            adView = (View) inflater.inflate(R.layout.ads_nativ_fb_smallsmall, null);
        } else {
...
//        clickableViews.add(nativeAdSocialContext);
        ...
        if (fbNativeAd_preLoad == null && state_fbNative.equals("Loaded")) {
            state_fbNative = "Start";
        }
    ...
    public void inflate_NATIV_FBSmall(com.facebook.ads.NativeAd nativeAd, ViewGroup card) {
        ...
        View adView;
//        if (mysharedpreferences.getString("appNativeAdSize", "").equals("small")) {
        adView = inflater.inflate(R.layout.ads_nativ_fb_smallsmall, null);
//        } else {
...
//        clickableViews.add(nativeAdSocialContext);
    ...
    private void showAdmobNativeSmall(final ViewGroup nativeAdContainer) {
        if (admob_n.isEmpty() || admob_AdStatus == 0) {
            nextNativePlatform(nativeAdContainer);
            return;
        }
        ...
        if (admobNativeAd_preLoad == null) {
            final AdLoader adLoader = new AdLoader.Builder(activity, admob_n).forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
                ...
                public void onNativeAdLoaded(NativeAd nativeAd) {
                    ...
                    inflate_NATIV_ADMOBSmall(nativeAd, nativeAdContainer);
                    new AdsAnalysis(activity).count_adAnalysis(ADMOB, "REQ_LOAD");
                    new AdsAnalysis(activity).count_adAnalysis(ADMOB, "AD_SHOW");
                }
            }).withAdListener(new AdListener() {
            ...
            state_admobNative = "Start";
            inflate_NATIV_ADMOBSmall(admobNativeAd_preLoad, nativeAdContainer);
        }
    }

    public void inflate_NATIV_ADMOB(NativeAd nativeAd, ViewGroup cardView) {
        ...
        if (nativeadtype == 1) {
            view = (View) inflater.inflate(R.layout.ads_nativ_admob_language, null);
        } else if (nativeadtype == 2) {
            view = (View) inflater.inflate(R.layout.ads_nativ_admob_language1, null);
        } else if (nativeadtype == 3) {
            view = (View) inflater.inflate(R.layout.ads_nativ_admob_intro, null);
        } else if (nativeadtype == 4) {
            view = (View) inflater.inflate(R.layout.ads_nativ_admob_intro1, null);
        } else {
            if (mysharedpreferences.getString("appNativeAdSize", "").equals("small")) {
...
//        }
        ...
        LinearLayout layoutADVdV = adView.findViewById(R.id.layoutADVV);
        TextView button = adView.findViewById(R.id.ad_call_to_action);
        TextView text1 = adView.findViewById(R.id.ad_headline);
        TextView text2 = adView.findViewById(R.id.ad_advertiser);
        TextView text3 = adView.findViewById(R.id.ad_body);
...
//            adView.getMediaView().setMediaContent(nativeAd.getMediaContent());
            ...
            if (mainUser.equals("no")) {
                if (!nativebg1.isEmpty()) {
                    layoutADVdV.setBackgroundColor(Color.parseColor(nativebg1));
                }
                if (!btncr1.isEmpty()) {
                    button.setBackgroundColor(Color.parseColor(btncr1));
                }
                if (!btntextcr1.isEmpty()) {
                    button.setTextColor(Color.parseColor(btntextcr1));
                }
                if (!adtextcolor1.isEmpty()) {
                    text1.setTextColor(Color.parseColor(adtextcolor1));
                    text2.setTextColor(Color.parseColor(adtextcolor1));
                    text3.setTextColor(Color.parseColor(adtextcolor1));
                }
            } else {
                if (!nativebg.isEmpty()) {
                    layoutADVdV.setBackgroundColor(Color.parseColor(nativebg));
                }
                if (!btncr.isEmpty()) {
                    button.setBackgroundColor(Color.parseColor(btncr));
                }
                if (!btntextcr.isEmpty()) {
                    button.setTextColor(Color.parseColor(btntextcr));
                }
                if (!adtextcolor.isEmpty()) {
                    text1.setTextColor(Color.parseColor(adtextcolor));
                    text2.setTextColor(Color.parseColor(adtextcolor));
                    text3.setTextColor(Color.parseColor(adtextcolor));
                }
            }
    ...
    public void inflate_NATIV_ADMOBSmall(NativeAd nativeAd, ViewGroup cardView) {
...
//        }
        ...
        RelativeLayout layoutADVdV = adView.findViewById(R.id.layoutADVV);
        TextView button = adView.findViewById(R.id.ad_call_to_action);
        TextView text1 = adView.findViewById(R.id.ad_headline);
        TextView text2 = adView.findViewById(R.id.ad_advertiser);
        TextView text3 = adView.findViewById(R.id.ad_body);
        ...
        if (interstitial_sequence.size() != 0) {
            ...
            if (platform.equals(ADMOB) && admob_AdStatus == 1) {
                ...
                InterstitialAd.load(activity, admob_i, adRequest, new InterstitialAdLoadCallback() {
                    ...
                    public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                        // Handle the error
                        Log.e("TAGaaaaa", loadAdError.getMessage());
                        mInterstitialAd[0] = null;
                        is_callback[0] = false;
                        if (loading_dialog == true) {
                            dialog.dismiss();
    ...
    public void showBackPressAd(Context context, MyCallback myCallback2) {
        ...
        if (appBackPressAdFormat.equals("Interstitial")) {
            ...
            AppManage.getInstance(context).showInterstitialBackAd(context, new MyCallback() {
